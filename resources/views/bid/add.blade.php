                                ...
                                <div class="row">
                                            ...
                                            <select class="form-control @error('service') is-invalid @enderror" name="service" id="service">
                                                ...
                                                @if (isset($data['all_services']) && count($data['all_services'])>0)
                                                    @foreach ($data['all_services'] as $item)
                                                        <option {{ old('service')==$item['id'] || (isset($data['service_id']) && $data['service_id'] == $item['id'])? 'selected': '' }} value="{{ $item['id'] }}">{{ $item['service_name'] }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            @error('service')
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('customer') is-invalid @enderror" name="customer" id="customer">
                                                <option value="">------ Choose Customer ------</option>
                                                @if (isset($data['all_customers']) && count($data['all_customers'])>0)
                                                    @foreach ($data['all_customers'] as $item)
                                                        <option {{ old('customer')==$item['id'] || (isset($data['customer_id']) && $data['customer_id'] == $item['id'])? 'selected': '' }} value="{{ $item['id'] }}">{{ $item['name'] }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            @error('customer')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input value="{{old('price', isset($data->price) ? $data->price : '')}}" type="number" id="price" class="form-control @error('price') is-invalid @enderror" placeholder="Price" name="price">
                                            @error('price')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input value="{{old('task_completion_date', isset($data->task_completion_date) ? $data->task_completion_date : '')}}" type="date" id="task_completion_date" class="form-control @error('task_completion_date') is-invalid @enderror" name="task_completion_date">
                                            @error('task_completion_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                            @enderror
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" class="form-control @error('description') is-invalid @enderror" placeholder="Description" name="description">{{old('description', isset($data->description) ? $data->description : '')}}</textarea>
                                            @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="pay_with" id="pay_with" class="form-control @error('pay_with') is-invalid @enderror" >
                                    ...
                                    <div class="col-md-6 col-12 for_provider_role">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('service') is-invalid @enderror" id="service" name="service">
                                                ...
                                                <option {{ old('service')==$item['id'] || (isset($data['assign_service'][0]['service']) && $data['assign_service'][0]['service'] == $item['id'])? 'selected': '' }} value="{{ $item['id'] }}">{{ $item['service_name'] }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                            @error('service')
